...
import numpy as np
from models import *
from dataset_anticipating_traffic import *
...
parser.add_argument("--dataset_path", type=str, default="data/Anticipating-Accident/Dachcam_dataset/obj_data", help="Path to extracted objects data")
parser.add_argument("--img_dataset_path", type=str, default="data/Anticipating-Accident/Dachcam_dataset/i3d", help="Path to I3D feature data")
...
"""
    ...
    global best_ap
    print("--Train with traffic anticipating data for DAD model--")
    model.eval()
