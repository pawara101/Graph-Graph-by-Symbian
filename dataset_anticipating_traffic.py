...
class Dataset(Dataset):
    ...
    def _extract_feature_paths(self, dataset_path, split_path="splits_antcipating_traffic/test_split.txt", training=True):
        ...
        fn = "test_split.txt"
        split_path = "splits_antcipating_traffic/test_split.txt"
