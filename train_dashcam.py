...
parser.add_argument("--dataset_path", type=str, default="data/dashcam/obj_data", help="Path to extracted objects data")
parser.add_argument("--img_dataset_path", type=str, default="data/dashcam/i3d_feat", help="Path to I3D feature data")
parser.add_argument("--obj_mapping_file", type=str, default="data/dashcam/obj_idx_to_labels.json",
                    help="path to object label mapping file")
parser.add_argument("--split_path", type=str, default="splits_dash/", help="Path to train/test split")
